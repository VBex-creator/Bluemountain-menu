const menuData = {
  "english_menu": {
    ...
    "chocolates_and_teas": [
      ...
      { "item": "Cascara Coffee Cherry Tea", "price": "4.00€", "description": "Drink made from the dried shell of coffee fruits. Rich in antioxidants." },
      { "item": "White Angel Tea", "price": "3.50€", "description": "Combination of white & green tea with cinnamon, orange peels, lemongrass, almond fillet & orange blossoms." },
  ...
  "greek_menu": {
    ...
    "σοκολάτες_και_τσάι": [
      ...
      { "item": "Μικρός Πρίγκιπας", "price": "3.50€", "description": "Κομμάτια μήλου, σταφύλι, φράουλα, ιβίσκος & χαμομήλι. Χωρίς καφεΐνη." },
      { "item": "Κόκκινη Πλατεία", "price": "3.50€", "description": "Τσάι φρούτων με έντονο κόκκινο χρώμα από ιβίσκο & κρανμπέρι με γεύση γλυκό-ξινή." },
      { "item": "Cascara Coffee Cherry Tea", "price": "4.00€", "description": "Ρόφημα φτιαγμένο από αποξηραμένο κέλυφος των καρπών του καφέ. Πλούσιο σε αντιοξειδωτικά." },
      { "item": "Λευκός Άγγελος", "price": "3.50€", "description": "Συνδυασμός λευκού & πράσινου τσαγιού με κανέλα, φλούδες πορτοκάλι, λεμονόχορτο, αμύγδαλο & ανθισμένα πορτοκάλια." },
      { "item": "Matcha Tea", "price": "4.00€" },
      { "item": "Black Tea", "price": "3.00€" },
      { "item": "Green Tea", "price": "3.00€" },
    ...
    "φαγητό_και_brunch": [
      ...
      { "item": "Beef Burger", "price": "12.00€", "description": "μαγιονέζα, μαρούλι, ντομάτα, τσένταρ, καραμελωμένο κρεμμύδι, μπέικον & παρμεζάνα" },
      { "item": "Chicken Burger", "price": "12.00€", "description": "μπιφτέκι κοτόπουλο, μαρούλι, ντομάτα, τσένταρ, καραμελωμένο κρεμμύδι, μπέικον & παρμεζάνα" },
      { "item": "Chicken Burger με Σνίτσελ Κοτόπουλο", "price": "12.00€", "description": "παναρισμένο με δημητριακά, τριμμένη γραβιέρα, σος αβοκάντο λεμόνι, ντομάτα, μαρούλι & καυτό τσίλι" },
      { "item": "Burger με Μοσχαρίσιο Μπιφτέκι", "price": "12.00€", "description": "ψητά λαχανικά, μαρούλι, ντομάτα, γραβιέρα Κρήτης, μαγιονέζα & καυτό σος τσίλι" },
      { "item": "Burger με Χοιρινά Πανσετάκια", "price": "12.00€", "description": "ντομάτα, ρόκα, τριμμένη φέτα, σως μουστάρδας & καυτό BBQ. Σερβίρεται με γλυκές πατάτες" },
      { "item": "Club Sandwich", "price": "7.50€" },
      ...
      { "item": "Φρεσκοψυμένο Κρουασάν Βουτυρου", "price": "10.00€", "description": "με μοτσαρέλα, μαρούλι, ντομάτα, αυγά ποσέ, σάλτσα ολανδέζικη & τριμμένη γραβιέρα" },
      { "item": "Προζυμένιο Ψωμί", "price": "13.50€", "description": "με χοιρινά μπριζολάκια, τυρί πατάτας, αλειφωτό τυρί, μανιτάρια, αυγά ποσέ & γραβιέρα" },
      { "item": "Αλμυρές Αυγόφετες", "price": "10.00€", "description": "με αλειφωτό τυρί, αυγό, μαρούλι, ντομάτα & τριμμένο τυρί regato" },
      { "item": "Τορτίγιο Κοτόπουλο", "price": "10.00€", "description": "με μαρούλι, ντομάτα, καλαμπόκι, flakes γραβιέρας & σάλτσα caesar" },
      { "item": "Eggs Benedict (Ζαμπόν)", "price": "9.00€", "description": "με τυρί κρέμα, μαρούλι, ντομάτα, φουαντρέ ζαμπόν, αυγό ποσέ & σάλτσα ολανδέζικη" },
      { "item": "Eggs Benedict (Κατίκι)", "price": "9.00€", "description": "με Κατίκι Δομοκού, μορταδέλα φυστικιού, μαρούλι, ντομάτα, αυγό ποσέ & σάλτσα ολανδέζικη" },
      ...
      { "item": "Spaghetti Pancakes Bowl", "price": "9.00€", "description": "Λεπτά pancakes σε μορφή ζυμαρικού με ρευστή κρέμα βανίλιας, φρέσκα φρούτα, αμύγδαλο & φυστίκι Αίγινας" },
      { "item": "French Toast με Nutella", "price": "10.50€", "description": "μπανάνα & τραγανό φουντούκι" },
